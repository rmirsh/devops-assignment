...
const Privacy = () => {
    ...
    return (
        <>
            <section className="container-main"  ref={privacyRef} title="Документы конфиденциальности">
                <h2 style={{marginTop: '30px', marginBottom: '60px'}} id="privacy">Политика в отношении обработки персональных
                    данных</h2>
                <p style={{textAlign: 'justify', lineHeight: '30px', marginBottom: '50px'}}>1. Общие положения<br/><br/>
                    ...
                    персональных данных, предпринимаемые ИП Хмура Татьяна Ивановна (далее — Оператор).<br/>
                    ...
                    данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://robotick.ru.<br/>
                    ...
                    определяемому Пользователю веб-сайта https://robotick.ru.<br/>
                    ...
                    2.10. Пользователь — любой посетитель веб-сайта https://robotick.ru.<br/>
                    ...
                    другими федеральными законами.<br/>
                    ...
                    Цель обработки предоставление доступа Пользователю к сервисам, информации и/или материалам,
                    ...
                    раскрытию в соответствии с федеральным законом.<br/><br/>
                    ...
                    e.mila-23@mail.ru с пометкой «Актуализация персональных данных».<br/>
                    ...
                    Оператору уведомление посредством электронной почты на электронный адрес Оператора e.mila-23@mail.ru
                    ...
                    действия третьих лиц, в том числе указанных в настоящем пункте поставщиков услуг.<br/>
                    ...
                    трансграничная передача персональных данных, соответствующие сведения.<br/><br/>
                    ...
                    предусмотрено федеральным законом.<br/><br/>
                    ...
                    его персональных данных, обратившись к Оператору с помощью электронной почты e.mila-23@mail.ru.<br/>
                    ...
                    https://robotick.ru/privacy.</p>

                <h2 style={{marginTop: '30px', marginBottom: '60px'}} id="agreement">Пользовательское соглашение</h2>
                <p style={{textAlign: 'justify', lineHeight: '30px', marginBottom: '50px'}}>
                    Настоящее Пользовательское Соглашение (Далее Соглашение) регулирует отношения между ИП Хмура Татьяна
                    Ивановна (далее или Администрация) с одной стороны и пользователем сайта с другой.
                    ...
                    <h5>Права и обязанности сторон</h5><br/>
                    ...
                    - не создавать несколько учётных записей на Сайте, если фактически они принадлежат одному и тому же
                    лицу<br/>
                    ...
                    с Сайтом и его Сервисами<br/><br/>
                    ...
                    от Администрации причинам.<br/><br/>

                    <h5>Ответственность сторон</h5><br/>
                    ...
                    также бесперебойную работу информационного ресурса<br/><br/>

                    <h5>Условия действия Соглашения</h5><br/>
